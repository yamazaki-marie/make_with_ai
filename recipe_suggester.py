...
class RecipeApp:
    ...
    def _build_ui(self):
        # タイトル
        title = tk.Label(
            self.root, text="🍳 食材から料理を提案", font=("Meiryo", 16, "bold"),
            bg="#f5f5f0", fg="#1a1a1a"
        )
        ...
        subtitle = tk.Label(
            ...
            font=("Meiryo", 10), bg="#f5f5f0", fg="#888"
        )
        ...
        tk.Label(frame_input, text="食材・調味料（カンマまたは改行で区切って入力）",
                 font=("Meiryo", 10), bg="#f5f5f0", fg="#444").pack(anchor="w")

        self.ingredients_text = scrolledtext.ScrolledText(
            frame_input, height=4, font=("Meiryo", 11),
        ...
        tk.Label(frame_options, text="ジャンル：",
                 font=("Meiryo", 10), bg="#f5f5f0", fg="#444").pack(side="left")
        ...
        for genre in ["どちらでも", "和食", "洋食", "中華"]:
            tk.Radiobutton(
                ...
                font=("Meiryo", 10), bg="#f5f5f0", fg="#333",
                activebackground="#f5f5f0"
            ).pack(side="left", padx=8)

        # ボタン
        self.suggest_btn = tk.Button(
            self.root, text="料理を提案する →", font=("Meiryo", 11, "bold"),
        ...
        self.result_text = scrolledtext.ScrolledText(
            frame_result, font=("Meiryo", 10), relief="solid", bd=1,
        ...
        status_bar = tk.Label(
            ...
            font=("Meiryo", 9), bg="#e8e8e3", fg="#666",
